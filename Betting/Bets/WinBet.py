...
class WinBet(Bet):
    ...
    def __init__(self, predicted_horse_results: List[HorseResult], stakes_fraction: float):
        ...
        self.potential_win = predicted_horse_results[0].win_betting_odds * stakes_fraction * (1 - Bet.WIN_COMMISION)
        self.odds = predicted_horse_results[0].win_betting_odds
    ...
    def __str__(self) -> str:
        ...
        bet_str += f"Odds of horse: {self.predicted_horse_results[0].win_betting_odds}\n"
