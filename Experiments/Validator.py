...
class Validator:
    ...
    def __create_random_fund_history(self, bettor: Bettor, estimator, name: str) -> FundHistorySummary:
        ...
        bet_results = BetEvaluator("train_race_cards").evaluate(bets)
...
def main():
    ...
    validator.train_validate_model(WinBettor(kelly_wealth=13), n_rounds=100, name="Gradient Boosted Trees Ranker")
