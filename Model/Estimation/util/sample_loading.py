...
from Model.Estimation.util.padding import RegressionLabelPaddingTransformer, FeaturePaddingTransformer3D
...
class RaceCardLoader(ABC):
    ...
    def __init__(
        ...
        self.feature_padding_transformer = FeaturePaddingTransformer3D(padding_size_per_group=20)
        ...
        horse_labels = sample.race_cards_dataframe[Horse.RANKING_LABEL_KEY].to_numpy()
        ...
        print(self.x.shape)
        self.n_feature_values = self.x.shape[2]
