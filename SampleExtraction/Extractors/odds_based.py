...
class BetfairPlaceMarketWinProbability(FeatureExtractor):
    ...
    def get_value(self, race_card: RaceCard, horse: Horse) -> float:
        inverse_odds = [1 / horse.place_sp for horse in race_card.horses if horse.place_sp > 0]
        ...
        if total_inverse_odds == 0 or horse.place_sp == 0:
            return self.PLACEHOLDER_VALUE
        return (1 / horse.place_sp) / total_inverse_odds
